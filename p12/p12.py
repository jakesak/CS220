...
highest_ranked = pd.DataFrame(rankings[rankings["World Rank"] == 1])
type(highest_ranked)
...
uw_madison = pd.DataFrame(rankings[rankings["Institution"] == "University of Wisconsin\u2013Madison"])
uw_madison
...
uw_madison_avg_score = pd.Series(uw_madison["Score"]).mean()
...
singapore_inst = pd.DataFrame(rankings[(rankings["Country"] == "Singapore") & (rankings["Year"] == "2020-2021")])
singapore_inst
...
german_best_name = rankings[(rankings["Year"] == "2019-2020") & (rankings["Country"] == "Germany")]["Institution"].iloc[0]
german_best_name
...
highest_german_rank = rankings[(rankings["Year"] == "2019-2020") & (rankings["Country"] == "Germany")]["World Rank"].iloc[0]
us_better_than_german_best = list(rankings[(rankings["Year"] == "2019-2020") & (rankings["Country"] == "USA") & (rankings["World Rank"] < highest_german_rank)]["Institution"])
...
china_2021 = rankings[(rankings["Year"] == "2021-2022") & (rankings["Country"] == "China")]
china_highest_qoe = china_2021[china_2021["Quality of Education Rank"] == china_2021["Quality of Education Rank"].min()]["Institution"].iloc[0]                                 
china_highest_qoe
...
india_highest_research = list(rankings[(rankings["Country"] == "India") & (rankings["Year"] == "2020-2021")].sort_values(by = "Research Performance Rank")["Institution"].iloc[:5])
...
# institutions_2019_2020_2021 = [institution for institution in institutions_2019 if institution in institutions_2020 and institution in institutions_2021]
...
for institution in institutions_2019_2020_2021:
    ...
    ranking_2019 = year_2019_ranking_df[year_2019_ranking_df["Institution"] == institution]["World Rank"].iloc[0]
    institution_dict["2019_ranking"] = ranking_2019
    ranking_2020 = year_2020_ranking_df[year_2020_ranking_df["Institution"] == institution]["World Rank"].iloc[0]
    institution_dict["2020_ranking"] = ranking_2020
    ranking_2021 = year_2021_ranking_df[year_2021_ranking_df["Institution"] == institution]["World Rank"].iloc[0]
    institution_dict["2021_ranking"] = ranking_2021
...
improved_institutions =  list(institutions_df[(institutions_df["2019_ranking"] - institutions_df["2021_ranking"]) > 500]["Institution"])
...
most_change_inst = institutions_df[abs(institutions_df["2019_ranking"] - institutions_df["2021_ranking"])== \
                abs(institutions_df["2019_ranking"] - institutions_df["2021_ranking"]).max()]["Institution"].iloc[0]
most_change_inst
...
strictly_improved = institutions_df[(institutions_df["2019_ranking"] > institutions_df["2020_ranking"]) & (institutions_df["2020_ranking"] > institutions_df["2021_ranking"])]["Institution"].count()
strictly_improved
...
alum_rank_10 = year_2020_ranking_df.sort_values(by = "Alumni Employment Rank")["Alumni Employment Rank"].iloc[9]
world_rank_10 = year_2020_ranking_df.sort_values(by = "World Rank")["World Rank"].iloc[9]
top_only_aer = list(year_2020_ranking_df[(year_2020_ranking_df["Alumni Employment Rank"] <= alum_rank_10) & (year_2020_ranking_df["World Rank"] >= world_rank_10)]["Institution"])
top_only_aer
...
top_100_2019 = set(year_2019_ranking_df.sort_values(by = "World Rank")["Institution"].iloc[:100])
top_100_2021 = set(year_2021_ranking_df.sort_values(by = "World Rank")["Institution"].iloc[:100])
top_only_2019 = list(top_100_2019 - top_100_2021)
top_only_2019
...
top_100_2020_countries = year_2020_ranking_df.sort_values(by = "World Rank").iloc[:100]["Country"].value_counts()
top_countries = list(top_100_2020_countries[top_100_2020_countries >= 10].index)
top_countries
...
url = "https://git.doit.wisc.edu/cdis/cs/courses/cs220/cs220-f22-projects/-/raw/main/p12/2019-2020.html"
download(url, "2019-2020.html")

# + tags=[]
# use the 'download' function to download the data from the webpage
# 'https://git.doit.wisc.edu/cdis/cs/courses/cs220/cs220-f22-projects/-/raw/main/p12/2020-2021.html'
# to the file '2020-2021.html'
url = "https://git.doit.wisc.edu/cdis/cs/courses/cs220/cs220-f22-projects/-/raw/main/p12/2020-2021.html"
download(url, "2020-2021.html")   

# + tags=[]
# use the 'download' function to download the data from the webpage
# 'https://git.doit.wisc.edu/cdis/cs/courses/cs220/cs220-f22-projects/-/raw/main/p12/2021-2022.html'
# to the file '2021-2022.html'
url = "https://git.doit.wisc.edu/cdis/cs/courses/cs220/cs220-f22-projects/-/raw/main/p12/2021-2022.html"
download(url, "2021-2022.html")
...
file_data = open("2019-2020.html", encoding="utf-8")
data_2019 = file_data.read()
file_data.close()
bs_obj_2019 = BeautifulSoup(data_2019, "html.parser")
table_2019 = bs_obj_2019.find("table")
header = []
th_2019_data = table_2019.find_all("th")
for th in th_2019_data:
    text = th.get_text()
    header.append(text)   
header
...
def parse_html(filename):
    ...
    html_data = file_data.read()
    file_data.close
    bs_obj = BeautifulSoup(html_data, "html.parser")
    table_data = bs_obj.find("table")
    header = []
    ...
    for tr in tr_data:
        td = tr.find_all("td")
        rows_data.append(td)
    year_data = str(filename)[:9]  #year
    for row in rows_data:
        table_data_dict ={}
        for idx in range(len(header)):
            col = header[idx]
            row_data = row[idx].get_text()
            if row_data == "-":
                row_data = None
            else:
                if col == "World Rank" or col == "National Rank" or col == "Quality of Education Rank" \
                or col == "Alumni Employment Rank" or col == "Quality of Faculty Rank" \
                or col == "Research Performance Rank":
                    row_data = int(row_data)
                elif col == "Score":
                    row_data = float(row_data)
            table_data_dict[col] = row_data
        table_data_dict["Year"] = year_data
...
parsed_2019 = parse_html("2019-2020.html")
rankings_2019_top_5 = parsed_2019[:5]
rankings_2019_top_5
...
parsed_2019 = parse_html("2019-2020.html")
parsed_2020 = parse_html("2020-2021.html")
parsed_2021 = parse_html("2021-2022.html")
all_data = []
all_data.extend(parsed_2019)
all_data.extend(parsed_2020)
all_data.extend(parsed_2021)
write_json("my_rankings.json", all_data)
